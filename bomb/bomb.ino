...
void loop(){ 
  ...
  if(flag == 0){
    ...
    if(Key == 2188238367 && flag_number1==0){flag_number1 = 1; flag = 1;}// 1
    if(Key == 1140038195 && flag_number2==0){flag_number2 = 1; flag = 1;}// 2
    if(Key == 2190883615 && flag_number3==0){flag_number3 = 1; flag = 1;}// 3
    if(Key == 2741114141 && flag_number4==0){flag_number4 = 1; flag = 1;}// 4
    if(Key == 2192983583 && flag_number5==0){flag_number5 = 1; flag = 1;}// 5
    if(Key == 2193373983 && flag_number6==0){flag_number6 = 1; flag = 1;}// 6
    if(Key == 2185384991 && flag_number7==0){flag_number7 = 1; flag = 1;}// 7
    if(Key == 2187862815 && flag_number8==0){flag_number8 = 1; flag = 1;}// 8
    if(Key == 2194569247 && flag_number9==0){flag_number9 = 1; flag = 1;}// 9
    if(Key == 2184590879 && flag_number10==0){flag_number10 = 1; flag = 1;}// 10
    
  }
    //========================2 ЕТАП(ЗЄДНАННЯ ПРОВОДІВ РУКАМИ)============
    if(flag==1)
    {  
      if(flag_start==0){
        time_start=millis();
        ...
        if(pressed!='\0')
          {
            ...
            if(string.length()==6)
            {
              if (flag_number1==1 && string.equals(string_code1)){flag_led++;flag_number1=2;digitalWrite(timer_on, LOW);Serial.println("good; timer_stop, LOW");mp3_play(4);flag=0;}      //правильний код
              if (flag_number2==1 && string.equals(string_code2)){flag_led++;flag_number2=2;digitalWrite(timer_on, LOW);Serial.println("good; timer_stop, LOW");mp3_play(4);flag=0;}      //правильний код
              if (flag_number3==1 && string.equals(string_code3)){flag_led++;flag_number3=2;digitalWrite(timer_on, LOW);Serial.println("good; timer_stop, LOW");mp3_play(4);flag=0;}      //правильний код
              if (flag_number4==1 && string.equals(string_code4)){flag_led++;flag_number4=2;digitalWrite(timer_on, LOW);Serial.println("good; timer_stop, LOW");mp3_play(4);flag=0;}      //правильний код
              if (flag_number5==1 && string.equals(string_code5)){flag_led++;flag_number5=2;digitalWrite(timer_on, LOW);Serial.println("good; timer_stop, LOW");mp3_play(4);flag=0;}      //правильний код
              if (flag_number6==1 && string.equals(string_code6)){flag_led++;flag_number6=2;digitalWrite(timer_on, LOW);Serial.println("good; timer_stop, LOW");mp3_play(4);flag=0;}      //правильний код
              if (flag_number7==1 && string.equals(string_code7)){flag_led++;flag_number7=2;digitalWrite(timer_on, LOW);Serial.println("good; timer_stop, LOW");mp3_play(4);flag=0;}      //правильний код
              if (flag_number8==1 && string.equals(string_code8)){flag_led++;flag_number8=2;digitalWrite(timer_on, LOW);Serial.println("good; timer_stop, LOW");mp3_play(4);flag=0;}      //правильний код
              if (flag_number9==1 && string.equals(string_code9)){flag_led++;flag_number9=2;digitalWrite(timer_on, LOW);Serial.println("good; timer_stop, LOW");mp3_play(4);flag=0;}      //правильний код
              if (flag_number10==1 && string.equals(string_code10)){flag_led++;flag_number10=2;digitalWrite(timer_on, LOW);Serial.println("good; timer_stop, LOW");mp3_play(4);flag=0;}      //правильний код       
              else //неправильний  
                {
                  string=""; 
